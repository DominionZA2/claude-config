...
- `agent-browser open <url>` -> `cmux browser open <url> --focus false`
...
```bash
cmux browser open <url> --focus false                        # opens in caller's workspace without selecting it
cmux browser open <url> --workspace <id|ref> --focus false   # opens in a specific workspace without selecting it
